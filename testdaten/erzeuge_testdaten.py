...
buche(137520, "S", 9000, 800, date(2025, 1, 1), "EB Kapital")  # 1.000 Differenz
...
buche(2261, "S", 4930, 1200, date(2025, 6, 20), "Armbanduhr Jubiläum GF", bu="9", beleg="AR-777")
...
buche(1000, "S", 800, 1200, date(2025, 6, 15), "Kapitalrückzahlung Anteil B", beleg="EK-01")      # BL-04
...
KONTONAMEN = {
    ...
    480: "Geringwertige Wirtschaftsgüter", 800: "Festkapital",
    ...
    3400: "Wareneingang 19 % VSt", 4120: "Gehälter",

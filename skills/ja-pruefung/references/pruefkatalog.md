...
|---|---|---|
| 1 – technische Integrität | Daten vollständig und konsistent? | DV, DQ, SB-05/06, OP-05, ST-05/06 |
| 2 – Regelprüfung | Verstoß gegen eindeutige Buchungs-/Bilanz-/Steuerregel? | SB-01/03/04, AF-01/03/04, US-01/03/04/06/07/08, RE, KR, OP-01/02/04, PP-03, ET |
| 3 – Plausibilität | Passt der Sachverhalt zu Schwellen, Struktur, Relationen? | SB-02/07/08/09, AF-02/05, US-02/10, OP-03/06/07, BL, CO, PP-01/02, GS, ST-01/03, FR-03, SD |
...
| EB = Schlussbilanz Vorjahr, EB je Konto | ➕ Vorjahresdaten |
| keine EB-Buchungen auf GuV-Konten | ✔ DV-02 |
| neue/verschwundene Bilanzkonten | ➕ Vorjahresdaten |
...
| Katalogpunkt | Status |
|---|---|
| wiederkehrende Zahlungen ohne RAP / RAP nicht aufgelöst | ✔ BL-01 |
| RAP-Alter, RAP-Veränderung | ➕ Vorjahresdaten |
| Rückstellung ohne Bewegung | ✔ BL-02 |
| identische Rückstellungsbeträge, Schwankungen, Abzinsung | ➕ Vorjahr/Verträge |
...
| Katalogpunkt | Status |
|---|---|
| Konto gegen Vorjahr/Vorperiode, Vorzeichenwechsel, erstmalig/leer | ➕ Vorjahres-SuSa |
| Monatsverlauf, Monatsspitzen | ✔ GV-01 |
| Verhältniskennzahlen (Material-, Personal-, Raum-, Werbe-, Kfz-Quote, Rohertrag) | ✔ Kennzahlen-Ausweis; Bewertung ➕ Vorjahr/Branche |
...
| Steuerbetrag mathematisch, Satz gegen Schlüssel | ✔ US-06/07 (Verprobung, mit SuSa), Konfiguration `steuerschluessel` |
...
| Katalogpunkt | Status |
|---|---|
| Geschenke über Grenze / falsches Konto | ✔ ET-01, ✔ ET-02 (Muster „Geschenk") |
| Bewirtung unplausibel | ✔ US-04 |
...
| Benford-Screening | ✔ ST-08 (ab 300 GuV-Buchungen) |
| Beträge knapp unter Freigabegrenzen / Aufteilung | ✔ FR-03, ✔ ST-07 |
| Wochenend-/Feiertagsbuchungen | ✔ ST-04 (Kasse, Belegdatum) |
...
| Umsatzsteuerkonten ↔ rechnerische USt/VSt | ✔ US-06/07 |
